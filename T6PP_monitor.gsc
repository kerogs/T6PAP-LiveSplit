...
init()
{
    ...
    player iprintln("^2https://github.com/kerogs/T6PAP");
}
...
check_split(split, is_flag)
{
    ...
    else
    {
        switch(split)
        {
            ...
            case "mansion":
                mansion_origin = (2745, 825, -165);  // Coordonnées à ajuster si besoin
                mansion_radius = 500;                // Ajuste le rayon à ta map
